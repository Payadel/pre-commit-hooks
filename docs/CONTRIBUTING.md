...
by [submitting an issue on GitHub](https://github.com/Payadel/pre-commit-hooks/issues). Before you create an issue,
...
1. Search our repository for open or closed
   [Pull Requests](https://github.com/Payadel/pre-commit-hooks/pulls)
